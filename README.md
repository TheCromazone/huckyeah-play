...
This repository holds **only the built game**, published so it can be played in a browser on
phone and desktop. The source lives in a private repository; nothing here is hand-written.
...
_Regenerate with `npm run publish` from the source repo._
